            ...
            @if (Auth::User()->usertype == 'Admin')
                <ul>
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="{{ classActivePath('season') }}"><a href="{{ URL::to('admin/season') }}"
                                        class="{{ classActivePath('season') }}"><i
                                            class="fa fa-tree"></i><span>{{ trans('words.seasons_text') }}</span></a>
                                </li>
                                <li class="{{ classActivePath('episodes') }}"><a
                                        href="{{ URL::to('admin/episodes') }}"
                                        class="{{ classActivePath('episodes') }}"><i
                                            class="fa fa-list"></i><span>{{ trans('words.episodes_text') }}</span></a>
                                </li>
                            </ul>
                        </li>
                    @endif
                    ...
                    @if (getcong('menu_sports'))
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i
                                    class="fa fa-futbol-o"></i><span>{{ trans('words.sports_text') }}</span><span
                                    class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                <li class="{{ classActivePath('sports_category') }}"><a
                                        href="{{ URL::to('admin/sports_category') }}"
                                        class="{{ classActivePath('sports_category') }}"><i
                                            class="fa fa-list"></i><span>{{ trans('words.sports_cat_text') }}</span></a>
                                </li>
                                <li class="{{ classActivePath('sports') }}"><a href="{{ URL::to('admin/sports') }}"
                                        class="{{ classActivePath('sports') }}"><i
                                            class="fa fa-soccer-ball-o"></i><span>{{ trans('words.sports_video_text') }}</span></a>
                                </li>
                            </ul>
                        </li>
                    @endif
                    ...
                    <li><a href="{{ URL::to('admin/actor') }}" class="waves-effect {{ classActivePath('actor') }}"><i
                                class="fa fa-user"></i><span>{{ trans('words.actors') }}</span></a></li>
                    <li><a href="{{ URL::to('admin/director') }}"
                            class="waves-effect {{ classActivePath('director') }}"><i
                    ...
                    <li class="has_sub">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="{{ classActivePath('home_sections') }}"><a
                                    href="{{ URL::to('admin/home_sections') }}"
                                    class="{{ classActivePath('home_sections') }}"><i
                                        class="fa fa-th-list"></i><span>{{ trans('words.home_section') }}</span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="has_sub">
                    ...
                    <li><a href="{{ URL::to('admin/coupons') }}"
                            class="waves-effect {{ classActivePath('coupons') }}"><i
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="{{ classActivePath('player_settings') }}"><a
                                    ...
                                    class="{{ classActivePath('player_settings') }}"><i
                                        class="fa fa-play-circle"></i><span>{{ trans('words.player_settings') }}</span></a>
                            </li>
                        ...
                        <ul class="list-unstyled">
                            <li class="{{ classActivePath('verify_purchase_app') }}"><a
                                    ...
                                    class="{{ classActivePath('verify_purchase_app') }}"><i
                                        class="fa fa-lock"></i><span>App Verify</span></a></li>
                            @if (env('BUYER_NAME') and env('BUYER_PURCHASE_CODE'))
                                ...
                                <li class="{{ classActivePath('ad_list') }}"><a
                                        href="{{ URL::to('admin/ad_list') }}"
                                        class="waves-effect {{ classActivePath('ad_list') }}"><i
                                            class="fa fa-buysellads"></i><span>Ad Settings</span></a></li>
                                <li class="{{ classActivePath('android_notification') }}"><a
                                        ...
                                        class="{{ classActivePath('android_notification') }}"><i
                                            class="fa fa-send"></i><span>{{ trans('words.android_app_notification') }}</span></a>
                                </li>
                            @endif
                        </ul>
                    </li>
                    ...
                    {{-- CrawlNguonTv --}}
                      <li><a href="{{ URL::to('admin/crawlnguontv') }}"
                            class="waves-effect {{ classActivePath('crawlnguontv') }}"><i
                                class="fa fa-list"></i><span>{{ "Crawl NguonTV" }}</span></a></li>
                @else
                    <ul>
                        <li><a href="{{ URL::to('admin/dashboard') }}"
                                class="waves-effect {{ classActivePath('dashboard') }}"><i
                                    class="fa fa-dashboard"></i><span>{{ trans('words.dashboard_text') }}</span></a>
                        </li>
                        <li><a href="{{ URL::to('admin/language') }}"
                                class="waves-effect {{ classActivePath('language') }}"><i
                        ...
                        @if (getcong('menu_shows'))
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i
                                        ...
                                        class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li class="{{ classActivePath('series') }}"><a
                                            href="{{ URL::to('admin/series') }}"
                                            class="{{ classActivePath('series') }}"><i
                                                class="fa fa-image"></i><span>{{ trans('words.shows_text') }}</span></a>
                                    </li>
                                    <li class="{{ classActivePath('season') }}"><a
                                            href="{{ URL::to('admin/season') }}"
                                            class="{{ classActivePath('season') }}"><i
                                                class="fa fa-tree"></i><span>{{ trans('words.seasons_text') }}</span></a>
                                    </li>
                                    <li class="{{ classActivePath('episodes') }}"><a
                        ...
                        @if (getcong('menu_sports'))
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="{{ classActivePath('sports') }}"><a
                                            href="{{ URL::to('admin/sports') }}"
                                            class="{{ classActivePath('sports') }}"><i
                                                class="fa fa-soccer-ball-o"></i><span>{{ trans('words.sports_video_text') }}</span></a>
                                    </li>
                                </ul>
                        ...
                        @if (getcong('menu_livetv'))
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="{{ classActivePath('live_tv') }}"><a
                                            href="{{ URL::to('admin/live_tv') }}"
                                            class="{{ classActivePath('live_tv') }}"><i
                                                class="fa fa-list"></i><span>{{ trans('words.tv_channel') }}</span></a>
                                    </li>
                                </ul>
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i
                                    ...
                                    class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                <li class="{{ classActivePath('slider') }}"><a
                                        href="{{ URL::to('admin/slider') }}"
                                        class="{{ classActivePath('slider') }}"><i
