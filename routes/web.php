...
use App\Http\Controllers\Admin\CrawlNguonController;
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    //Route crawl nguontv
    Route::controller(CrawlNguonController::class)->group(function () {
        Route::get('crawlnguontv',  'crawlnguon');
        Route::post('check_nguon', 'check_nguon')->name('crawlnguon.check');
        Route::post('crawl_by_id', 'crawl_by_id')->name('crawlnguon.crawl_one');
        Route::post('crawl_page', 'crawl_page')->name('crawlnguon.crawl_page');
        Route::post('get_movies_page', 'get_movies_page')->name('crawlnguon.get_movies_page');
    });
